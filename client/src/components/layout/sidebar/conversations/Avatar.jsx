...
export const Avatar = ({ type, unread }) => {
  return (
    <div className='conversation-avatar relative min-w-10 min-h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-medium border border-primary/20'>
      {type === 'PRIVATE' ?
        <UserRound />
      : <UsersRound />}
      {unread > 0 && (
